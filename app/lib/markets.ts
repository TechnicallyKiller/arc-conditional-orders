...
export type Market = {
  ...
  hooks: `0x${string}`;
  decimals: number;
  /** Measured price impact of a real $500 sell, in basis points, excluding the pool fee. */
...
export const MARKETS: Market[] = [
  {
    ...
    decimals: 18, impactBps: 0, poolFeeBps: 100, sellTestPassed: true,
  },
  {
    ...
    decimals: 18, impactBps: 0, poolFeeBps: 1, sellTestPassed: true,
  },
  {
    ...
    decimals: 18, impactBps: null, poolFeeBps: 25, sellTestPassed: false,
  },
];
...
export const TESTNET_MARKET: Market = {
  ...
  decimals: 18, impactBps: 0, poolFeeBps: 0, sellTestPassed: true,
};
